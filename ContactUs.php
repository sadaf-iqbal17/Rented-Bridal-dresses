...
<form class="col-lg-12 col-md-12 c-form border-dark" action="ContactUs.php"method="POST" class="col-lg-2">
  <h2>Contact Us</h2><br>
  <label >Name</label><br>
  ...
  <textarea  cols="42" rows="5" name="message" required></textarea><br><br>
              ...
              <div class="row py-4">
                ...
                <div class="col-lg-2 col-md-6 mb-4 mb-lg-0">
                  ...
                  <ul class="list-unstyled mb-0">
                    ...
                    <li class="mb-2"><a href="Bookdresses.php">Our Products</a></li>
                  </ul>
                </div>
